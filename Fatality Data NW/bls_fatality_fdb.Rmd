...
```{r}
ggplotly(make_scatterplot(df_3117XX, "Employee status", by = "Year"))
```
...
```{r}
ggplotly(make_barplot(df_3117XX, "Worker activity"))
```
...
```{r}
ggplotly(make_barplot(df_3117XX, "Part of body"))
```
...
```{r}
ggplotly(make_barplot(df_3117XX, "Location"))
```
...
```{r}
ggplotly(make_barplot(df_3117XX, "Occupation"))
```
